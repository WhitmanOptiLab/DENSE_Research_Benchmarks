...
int main(int argc, char* argv[]){
  ...
  simulate_experiment<Fast_Gillespie_Direct_Simulation>(ac, av, &args, "Exponential_Experiment/Fast_Gillespie_Exponential");
  ...
  simulate_experiment<Stochastic_Simulation>(ac, av, &args, "Exponential_Experiment/Gillespie_Direct_Exponential");
  ...
  simulate_experiment<Anderson_Next_Reaction_Simulation>(ac, av, &args, "Exponential_Experiment/Anderson_Exponential");
  ...
  simulate_experiment<Rejection_Based_Simulation>(ac, av, &args, "Exponential_Experiment/Rejection_Based_Density");
  std::cout << style::apply(Color::yellow) << "Finished the Rejection Based Simulation\n\n" << style::reset();
  
//  std::cout << "Starting the Next Reaction Simulation\n" << style::reset();
  //simulate_experiment<Next_Reaction_Simulation>(ac, av, &args, "Exponential_Experiment/Next_Reaction_Exponential");
