...
STATIC_VAR int num_deltas_reaction8 = 4;
STATIC_VAR int deltas_reaction8[] = {-1, 1, 1, 2};
STATIC_VAR specie_id delta_ids_reaction8[] = {specie2,specie3,specie1,specie4};

STATIC_VAR int num_deltas_reaction9 = 3;
STATIC_VAR int deltas_reaction9[] = {-1, 1, 2};
STATIC_VAR specie_id delta_ids_reaction9[] = {specie3,specie1,specie2};

STATIC_VAR int num_deltas_reaction10 = 3;
STATIC_VAR int deltas_reaction10[] = {-1, -1, 1};
STATIC_VAR specie_id delta_ids_reaction10[] = {specie3,specie1,specie4};

STATIC_VAR int num_deltas_reaction11 = 2;
STATIC_VAR int deltas_reaction11[] = {-1, 1};
STATIC_VAR specie_id delta_ids_reaction11[] = {specie4,specie3};

STATIC_VAR int num_deltas_reaction12 = 3;
STATIC_VAR int deltas_reaction12[] = {-1, 1, 1};
STATIC_VAR specie_id delta_ids_reaction12[] = {specie2,specie1,specie3};