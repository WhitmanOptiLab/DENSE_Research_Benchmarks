...
int main(int argc, char* argv[]){
  ...
  simulate_experiment<Stochastic_Simulation>(ac, av, &args, "Overhead_Experiment/Gillespie_Direct_Overhead");
  ...
  simulate_experiment<Anderson_Next_Reaction_Simulation>(ac, av, &args, "Overhead_Experiment/Anderson_Overhead");
  ...
  simulate_experiment<Rejection_Based_Simulation>(ac, av, &args, "Overhead_Experiment/Rejection_Based_Overhead");
