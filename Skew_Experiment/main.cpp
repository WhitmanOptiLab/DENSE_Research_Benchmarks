...
int main(int argc, char* argv[]){
  ...
  simulate_experiment<Stochastic_Simulation>(ac, av, &args, "Skew_Experiment/Gillespie_Direct_Skew");
  ...
  simulate_experiment<Anderson_Next_Reaction_Simulation>(ac, av, &args, "Skew_Experiment/Anderson_Skew");
  ...
  simulate_experiment<Rejection_Based_Simulation>(ac, av, &args, "Skew_Experiment/Rejection_Based_Skew");
