...
STATIC_VAR int num_deltas_reaction1 = 4;
STATIC_VAR int deltas_reaction1[] = {-1, -1, 2, 3};
STATIC_VAR specie_id delta_ids_reaction1[] = {specie1,specie4,specie2,specie3};

STATIC_VAR int num_deltas_reaction2 = 2;
STATIC_VAR int deltas_reaction2[] = {-1, 1};
STATIC_VAR specie_id delta_ids_reaction2[] = {specie4,specie3};

STATIC_VAR int num_deltas_reaction3 = 2;
STATIC_VAR int deltas_reaction3[] = {-1, 3};
STATIC_VAR specie_id delta_ids_reaction3[] = {specie2,specie4};

STATIC_VAR int num_deltas_reaction4 = 2;
STATIC_VAR int deltas_reaction4[] = {-1, 1};
STATIC_VAR specie_id delta_ids_reaction4[] = {specie3,specie1};